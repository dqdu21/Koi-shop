          ...
          <div className="min-h-[70vh]">
            ...
            {orders.map((order:any) => (
              <Card className="p-8"  >
                ...
                <div className="flex flex-row gap-2 items-center">
                  <h1 className="font-semibold text-[1.2em]">Payment Method:</h1>
                  <p>VNPAY</p>
                </div>
                <div className="flex flex-row gap-2 items-center">
                ...
                {order.orderItems.map(
                  (item : any) => (
                    <Card className='cursor-pointer px-8 py-4 my-2 grid grid-cols-[1fr_4fr_1fr] gap-2 bg-[#333333] text-white' onClick={() => navigate(`/product/${item.productId}`)} >
      <img
